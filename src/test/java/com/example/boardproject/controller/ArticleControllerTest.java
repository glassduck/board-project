...
class ArticleControllerTest {
    ...
    @Test
    public void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsSearchHashtagView() throws Exception {
        // Given
    ...
    @Test
    public void givenHashtag_whenRequestingArticleSearchHashtagView_thenReturnsSearchHashtagView() throws Exception {
        //
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
